...
def remove_square_bracket_text(text):
    # Use regex to find and remove text within square brackets
    cleaned_text = re.sub(r'\[.*?\]', '', text)
    return cleaned_text

# The given long paragraph with 20000+ characters
long_paragraph = """
...
cleaned_paragraph = remove_square_bracket_text(long_paragraph)
